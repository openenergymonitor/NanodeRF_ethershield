...
#define API "/emoncms2/api/post?apikey=0e683eadd934363577f3033e890f7325&json="  // Your api url including APIKEY
byte ip[4] = {192,168,2,83};                                   // Server IP
byte gateway[4] = {192,168,2,1}; 
byte server[4] = {192,168,2,100}; 
//---------------------------------------------------------------------
...
{
  Serial.begin(9600);
  Serial.println("Emonbase:NanodeRF ctonly static ip");
